...
# 检查2: og:image占位图
if grep -q 'placeholder-og-image.png' index.html 2>/dev/null; then
    ISSUE_FOUND="og:image占位图"
    sed -i '' 's|/images/placeholder-og-image.png|https://lockclub.wangjile.cn/领锁-三大核心价值长图.png|g' index.html
